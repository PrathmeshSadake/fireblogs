        ...
        <div className='xl:px-20 md:px-10 sm:px-6 px-4 md:py-12 py-9 2xl:mx-auto 2xl:container md:flex items-center justify-center'>
          ...
          <div className='xl:w-1/3 md:w-1/2 lg:ml-16 ml-8 md:mt-0 mt-6'>
            <div className='pl-8 md:block hidden'>
              <p className='text-2xl leading-7 text-gray-800 font-medium tracking-wider'>
                Fireblogs
              </p>
            </div>
            <div className='flex items-start mt-8'>
              ...
              <p className='sm:text-2xl text-xl leading-7 text-gray-600 pl-2.5'>
                Over 100,000 blogs and growing. Be part of an active community
                of bloggers and creators. Blog on a personal domain, share
                ideas, and connect with the global community.
              </p>
            </div>
